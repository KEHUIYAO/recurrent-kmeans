...
bias=abs((centroids-[150 0.25 0.1;200 0.25 0.1])./[150 0.25 0.1;200 0.25 0.1]);



SSE=[0 0 0;0 0 0];
for i=index_list
    SSE=SSE+(autosort(centroids_list{i})-[150 0.25 0.1;200 0.25 0.1]).^2;
end
...
save r3.mat num_accuracy centroids bias RMSE accuracy;